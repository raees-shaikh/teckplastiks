            ...
            <div class="statbox widget box box-shadow my-1">
                <div class="widget-header">
                    <div class="row justify-content-between align-items-center ">
                        ...
                        <div class="col-xl-4 col-md-6 mb-2 px-0 d-flex justify-content-end align-it mt-2">
                        ...
                        <form class="mt-3" method="POST" action="{{ route('cms.offer.store') }}"
                            ...
                            <div class="form-group mb-6 row">
                                ...
                                <div class="col-12 mb-3 mt-2">
                                    ...
                                    <textarea id="mymce" class="team-about" name="body" minlength="3" maxlength="20000">{{ old('body') }}</textarea>
                                    @if ($errors->has('body'))
