            ...
            <div class="statbox widget box box-shadow my-1 px-3">
                <div class="widget-header">
                    <div class="row justify-content-between align-items-center ">
                        ...
                        <div class="col-xl-4 col-md-6 mb-2 d-flex justify-content-end align-it mt-2 px-0">
                        ...
                        <form class="mt-3" method="POST" action="{{ route('cms.data.store') }}"
                            ...
                            <div class="form-group mb-4 row">
                                <div class="col-xl-12  col-md-6 col-sm-12">
                                    ...
                                    <input type="file" class="form-control" id="formGroupExampleInput" minlength="3"
                                        maxlength="60" required name="filename" value="{{ old('filename') }}">
