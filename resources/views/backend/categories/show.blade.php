...
@section('title', 'Category - ' . $categories->title)
@section('content')
            ...
            <div class="statbox widget box box-shadow my-1 px-3">
                <div class="widget-header">
                    <div class="row justify-content-between align-items-center mb-1">
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6 mb-2 d-flex px-0 justify-content-end align-it mt-2 ">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="degree3" class="cust-title" class="label-title">Category
                                                    Name</label><br>
                                                <p class="label-title">{{ $categories->title }}</p>
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-12">
                                            <div class="form-group">
